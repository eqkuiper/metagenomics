...
#SBATCH -N 1
#SBATCH -n 4
#SBATCH --array=0-2 # change to number of metagenomes
...
sample_list=/projects/p32449/maca_mags_metabolic/data/mags_to_annotate_test.txt
parent_dir=/projects/p32449/maca_mags_metabolic/data
bins_a_dir=/scratch/jhr1326/2025-10-21_COMEBin
bins_b_dir=${parent_dir}/2025-10-07_maca_metaG/03_metabat2-scaffolds-c_1500
bins_c_dir=/scratch/jhr1326/metadecoder_results
output_dir=${parent_dir}/2025-10-07_maca_metaG/metaWRAP-refined-bins-50compl-50contam
####             ####
...
metawrap bin_refinement \
  ...
  -B ${bins_b_dir}/${metagenome} \
  -C ${bins_c_dir}/${metagenome} \
  -c 50 -x 50
